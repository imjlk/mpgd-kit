...
The publication follow-up imports the scene binding from `@mpgd/game-runtime/phaser`.
It removes the separate private binding package while preserving the fixture's
gameplay, lifecycle and fake-service scenarios.
