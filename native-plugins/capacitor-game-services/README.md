...
application-support directory so write failures reach the bridge. Missing
values return `null`, while serialization, quota, and provider failures reject
through bridge errors without replacing a previously committed value.
