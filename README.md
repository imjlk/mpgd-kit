...
- [Documentation index](docs/index.md) separates verified guides, integration
  notes, and roadmap material.
...
- [Purchase and Reward Recovery](docs/MONETIZATION_RECOVERY.md)
