...
- [ ] On Windows in an active administrator user session, run `pnpm exec mpgd target accept-package microsoft-store --packages <PWABuilder packages>` and attach `release-output/microsoft-store/package-acceptance.json` plus the WACK reports.
