...
the trusted native host operation that creates the User Collections ID. The recommended sign-in
method keeps the Microsoft ID token, publisher ticket, and User Collections ID native and returns
only a short-lived game-scoped session to web content.
